...
char ssid[32] = "Nothing";     // enter WiFi router ssid inside the quotes
char pwd [32] = "kovy1799"; // enter WiFi router password inside the quotes
...
void ESPconfig()
{
    ...
    strcpy(snd, "srv=net.createServer(net.TCP)\r\n");
      ...
      wait(1);
        ...
        strcpy(snd, "conn:send(\"<h1> Hi Jack&Andre, NodeMcu.</h1>\")\r\n");
      SendCMD();
        wait(1);
